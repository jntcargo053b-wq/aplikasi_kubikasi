...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<Pengiriman> get _displayed {
    final selectedPengirim =
        _pengirimList.contains(_pengirim) ? _pengirim : 'Semua';
    final list = _items.where((e) {
      if (!_matchesSearch(e)) return false;
      if (selectedPengirim != 'Semua' && e.pengirim != selectedPengirim) return false;
